...
//首页类
class FlutterLoginPage extends StatefulWidget {
  @override
...
//首页状态类
class _LoginPageState extends State<FlutterLoginPage> with SingleTickerProviderStateMixin {
...
//                Text(""),
                SizedBox(
                  width: 90,
                  height: 90,
                  child: CircularProgressIndicator(backgroundColor: Colors.grey[200], valueColor: AlwaysStoppedAnimation(Colors.blue), strokeWidth: 5.0, value: 0.8,),
                ),
                Text(""),
